export const socialData = [
  {
    ...
    name: 'facebook',
    style: { header: 'text-[4vh] text-gray-500 mx-1', footer: 'text-[5vh] text-gray-400 mx-2' },
  ...
  },
  {
    ...
    name: 'youtube',
    style: { header: 'text-[5vh] text-gray-500 mx-1', footer: 'text-[6vh] text-gray-400 mx-2' },
    link: '',
  ...
  },
  {
    ...
    name: 'twitter-x',
    style: { header: 'text-[3.5vh] text-gray-500 mx-1', footer: 'text-[4.5vh] text-gray-400 mx-2' },
    link: '',
